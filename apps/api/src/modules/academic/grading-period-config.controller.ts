...
@Controller('grading-period-config')
@UseGuards(JwtAuthGuard, RolesGuard)
export class GradingPeriodConfigController {
  constructor(private readonly service: GradingPeriodConfigService) {}

  // Obtener configuración de períodos por año académico (admin/coordinador)
  @Get()
  ...
  // Obtener estado de períodos para docentes
  @Get('status')
  ...
  // Verificar si un período específico está abierto
  ...
  // Actualizar configuración de un período (solo admin/coordinador)
  @Post(':academicTermId')
  @Roles('SUPERADMIN', 'ADMIN_INSTITUTIONAL', 'COORDINADOR')
  async upsertConfig(
