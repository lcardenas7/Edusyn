    ...
    try {
      ...
      if (reportId === 'att-teacher') {
        const p = {
          ...
          teacherId: isTeacher ? user?.id : (filterTeacher !== 'all' ? filterTeacher : undefined),
