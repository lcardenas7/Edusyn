...
const reportCategories: CategoryItem[] = [
  { id: 'admin', name: 'Administración / Rectoría', icon: Briefcase, color: 'blue' },
  { id: 'academic', name: 'Académico (Coordinación)', icon: BookOpen, color: 'green' },
  { id: 'evaluation', name: 'Evaluación (SIEE)', icon: ClipboardList, color: 'purple' },
  { id: 'attendance', name: 'Asistencia', icon: Calendar, color: 'amber' },
  { id: 'official', name: 'Boletines', icon: FileText, color: 'indigo' },
  { id: 'alerts', name: 'Alertas y Estadísticas', icon: Bell, color: 'red' },
  { id: 'config', name: 'Configuración / Control', icon: Settings, color: 'slate' },
]
