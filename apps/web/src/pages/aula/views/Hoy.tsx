...
function HoyEstudiante({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      {/* Avance del período */}
      {/* En pantalla grande, dos columnas: a la izquierda lo que hay que HACER, a la derecha
          lo de consultar. Con una sola columna estrecha sobraba media pantalla vacía y todo
          quedaba a golpe de scroll. */}
...
function HoyDocente({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      {/* Dos columnas en pantalla grande: el trabajo a la izquierda, el muro a la derecha.
          Con una sola columna estrecha sobraba media pantalla y los anuncios quedaban tan
          abajo que nadie los veía. */}
      <div className="grid gap-5 lg:grid-cols-3">
