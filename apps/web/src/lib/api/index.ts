...
export const observerApi = {
  ...
  exportPedagogicalFollowups: (observationIds: string[]) =>
    api.post('/observer/pedagogical-followups/export', { observationIds }, { responseType: 'blob' }),
  // Compromisos
...
export const studentsApi = {
  ...
  bulkPasswordEqualsUsername: (studentIds: string[]) => api.post('/students/bulk-password-equals-username', { studentIds }),
...
export const classroomApi = {
  ...
  updateFormativeDraft: (id: string, data: any) => api.put(`/formative-evaluations/${id}`, data),
  deleteFormativeDraft: (id: string) => api.delete(`/formative-evaluations/${id}`),
  getFormativePeerPreview: (id: string, seed?: string) => api.get(`/formative-evaluations/${id}/peer-preview`, { params: seed ? { seed } : {} }),
  publishFormativeEvaluation: (id: string, data?: { peer?: { mode: 'auto'; seed: string } | { mode: 'manual'; pairs: Array<{ dimensionId: string; evaluator: string; target: string }> } }) => api.post(`/formative-evaluations/${id}/publish`, data ?? {}),
  ...
  getFormativeInsights: (id: string) => api.get(`/formative-evaluations/${id}/insights`),
  reviewFormativeComment: (assignmentId: string, status: 'APPROVED' | 'REJECTED') => api.patch(`/formative-evaluations/assignments/${assignmentId}/comment`, { status }),
