...
export const abpApi = {
  ...
  addMission: (teamId: string, phase: number, data: { title: string; description?: string; required?: boolean; deliverableKind?: string }) => api.post<any>(`/abp/teams/${teamId}/phases/${phase}/missions`, data),
