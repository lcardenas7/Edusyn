        ...
        <div className="flex-1 bg-slate-50 overflow-hidden relative">
          ...
          {showSuccess && (
            <div className="absolute inset-0 bg-white/90 flex flex-col items-center justify-center animate-fadeIn">
              ...
              <div className="text-lg font-bold text-slate-900">¡Aprendizajes asignados!</div>
    ...
    <div className="h-full animate-fadeIn">
      ...
      <div className="px-4 py-2 border-b border-slate-200 bg-white flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold text-slate-900">Aprendizajes y Evidencias</span>
        </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-2">
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[8px] text-slate-600">{selectedLogros.length} aprendizajes</span>
                </div>
                <div className="flex items-center gap-1">
                  <Star className="w-3 h-3 text-amber-500" />
