...
|-------|---------|--------|-----------|--------|
| 2026-09-23 | staging | `e9d06320` | **Sí** (`20260923010000_aviso_actividad_publicada`, aditiva) | **Aula móvil, avisos, períodos y entregas + Classroom B1 17/98.** Publicación y listado de estudiantes con cadena institucional; avisos solo después del commit; entregas por apellido con filtros Entregaron/Todos/Sin entregar; advertencia al quedar vacío un período; estilo interior actualizado. API 114 suites/2431 pruebas, web 41/526, CREA 11, tipos y builds verdes. PostgreSQL local desechable: 105 migraciones/0 fallidas con roles RLS. Push confirmado. Pendientes: hash real de Railway y recorrido autenticado en staging antes de producción; Classroom sigue parcial. |
