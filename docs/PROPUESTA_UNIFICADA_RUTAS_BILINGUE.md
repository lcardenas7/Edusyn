...
- **Pendiente:** UI de la ruta (mapa de pasos, maqueta ya validada), componentes de inglés (Reading/Listening/Writing) + evidencia que alimenta el "% dominado" del can-do (increment 3), y creación de rutas "con Valeria".
