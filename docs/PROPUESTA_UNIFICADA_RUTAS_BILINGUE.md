...
- **Pendiente:** UI de progreso del estudiante (barra "% dominado" + estado por paso leyendo `/progress`), enganchar pasos a actividades desde la UI (increment 3b), componentes de inglés R/L/W nuevos (Writing libre + Listening audio) e IA de generación, y creación de rutas "con Valeria".
