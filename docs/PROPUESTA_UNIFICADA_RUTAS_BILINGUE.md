...
- **Pendiente:** componentes nativos Listening (audio TTS) y lanzar quizzes/lecciones enlazados desde el mapa (hoy inline solo Tarea/Writing); Speaking (motor de voz, Fase 1).
